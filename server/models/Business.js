...
const businessSchema = new mongoose.Schema({
  ...
  type: {
    type: String,
    enum: ['RETAIL', 'SUPERMARKET', 'PHARMACY', 'WHOLESALE', 'DISTRIBUTION', 'OTHER'],
    required: true,
  },
  ...
  settings: {
    ...
    staffSalesTrackingMode: {
      type: String,
      enum: ['INDIVIDUAL', 'TILL', 'BRANCH_ONLY'],
      default: 'INDIVIDUAL',
    },
  ...
  subscription: {
    plan: { type: String, enum: ['STARTER', 'GROWTH', 'CUSTOM'], default: 'STARTER' },
